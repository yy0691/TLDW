-- Complete fix for local video upload and analysis save
...
-- ============================================
-- Part 3: Drop and recreate all policies
-- ============================================

-- video_analyses policies
...
-- ============================================
-- Part 4: Create or replace RPC function
-- ============================================
...
WHERE routine_name = 'upsert_video_analysis_with_user_link';
...
SELECT 
  ...
  cmd
FROM pg_policies
WHERE tablename IN ('video_analyses', 'user_videos')
ORDER BY tablename, policyname;

-- Success message
DO $$
BEGIN
  RAISE NOTICE '✅ Setup complete! Local video upload should now work.';
END $$;
